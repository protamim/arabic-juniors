...
const ArabicCurriculumn = () => {
  return (
    <React.Fragment>
      <section aria-label="arabic-curricolumn-section" className="py-16">
        <div className="container">
          ...
          >
            ...
            <div aria-label="arabic-curricolumn-right">
              <h3 className="text-neutral-900 text-5xl font-bold leading-tight mb-6">
                Experience in UAE School{" "}
                <span className="text-orange-500">Arabic Curriculum</span>
              </h3>
              <p className="text-neutral-700 font-normal text-lg mb-6">
              ...
              >
                ...
                >
                  <span className="flex items-center justify-center bg-[#0062FC] w-16 h-16 rounded-full p-3">
                    <NativeArabicUserIcon className="text-3xl text-white" />
                  </span>
                  <div className="flex flex-col gap-y-3">
                    <h4 className="text-neutral-800 font-bold text-2xl">
                ...
                <li
                  ...
                  className="flex items-center gap-x-5"
                >
                  <span className="flex items-center justify-center bg-yellow-500 w-16 h-16 rounded-full p-3">
                ...
                <li
                  ...
                  className="flex items-center gap-x-5"
                >
                  <span className="flex items-center justify-center bg-light-green-500 w-16 h-16 rounded-full p-3">
